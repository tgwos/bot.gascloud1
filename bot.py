...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_photo(
        photo=LOGO_URL,
        caption="<b>BENVENUTO</b>\n\n, VISTI I CONTINUI B4N DI T3L3GRAM TI CONSIGLIO DI SCARICARE S1GNAL E UNIRTI AL NOSTRO GRUPPO PER RIMANERE SEMPRE AGGIORNATO E IN CONTATTO CON NOI. ",
